...
function Callout({ type = "info", title, children }) {
    ...
    return (<div className={`my-6 rounded-lg border-2 ${styles.bg} ${styles.border} not-prose`}>
      <div className="flex items-center gap-3 p-4">
        ...
        <div className="flex-1 min-w-0">
          {title && (<p className="font-heading font-bold text-neo-dark m-0 leading-tight">{title}</p>)}
