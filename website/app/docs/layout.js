      ...
      <header className="sticky top-0 z-40 bg-cream/90 backdrop-blur-sm border-b-2 border-black">
        <div className="flex items-center justify-between h-16 px-4 md:px-6 lg:px-8">
          <div className="flex items-center gap-4">
            ...
            <link_1.default href="/docs" className="font-heading font-medium text-neo-dark/70 hover:text-neo-dark transition-colors">
              Docs
            </link_1.default>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden md:block lg:hidden">
              <docs_1.DocsMobileSidebar mode="slide" iconOnly/>
            </div>

            {/* Small screen menu button (below md) - fullscreen modal */}
            <div className="md:hidden">
              <docs_1.DocsMobileSidebar mode="fullscreen" iconOnly/>
            </div>

            <a href="https://github.com/keep-starknet-strange/starknet-agentic" target="_blank" rel="noopener noreferrer" className="p-2 text-neo-dark/60 hover:text-neo-dark transition-colors" aria-label="GitHub repository">
