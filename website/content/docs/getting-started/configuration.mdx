...
| Blast API | 12M requests/month | [blastapi.io](https://blastapi.io/) |
...
For mainnet with significant funds, use a hardware wallet (Ledger) with ArgentX.
...
<FAQItem question="How do I rotate my private key?">
  Starknet accounts support key rotation. Generate a new key pair, then use your current key to authorize the new one. See the [ArgentX documentation](https://www.argent.xyz/learn/how-to-change-your-argent-x-guardian/) for details.
</FAQItem>
