...
These addresses are official, team-verified ERC-8004 deployments. Canonical source-of-truth and verification metadata are tracked in `docs/DEPLOYMENT_TRUTH_SHEET.md`. For your own deployment, follow the steps above.
</Callout>
...
|----------|---------|--------------|
| IdentityRegistry | `0x72eb37b0389e570bf8b158ce7f0e1e3489de85ba43ab3876a0594df7231631` | Team-verified; see `docs/DEPLOYMENT_TRUTH_SHEET.md` |
| ReputationRegistry | `0x5a68b5e121a014b9fc39455d4d3e0eb79fe2327329eb734ab637cee4c55c78e` | Team-verified; see `docs/DEPLOYMENT_TRUTH_SHEET.md` |
| ValidationRegistry | `0x7c8ac08e98d8259e1507a2b4b719f7071104001ed7152d4e9532a6850a62a4f` | Team-verified; see `docs/DEPLOYMENT_TRUTH_SHEET.md` |
| AgentAccountFactory | `0x358301e1c530a6100ae2391e43b2dd4dd0593156e59adab7501ff6f4fe8720e` | Team-verified; see `docs/DEPLOYMENT_TRUTH_SHEET.md` |

**Mainnet:**

| Contract | Address | Verification |
|----------|---------|--------------|
| IdentityRegistry | `0x33653298d42aca87f9c004c834c6830a08e8f1c0bd694faaa1412ec8fe77595` | Team-verified; see `docs/DEPLOYMENT_TRUTH_SHEET.md` |
| ReputationRegistry | `0x698849defe3997eccd3dc5e096c01ae8f4fbc2e49e8d67efcb0b0642447944` | Team-verified; see `docs/DEPLOYMENT_TRUTH_SHEET.md` |
| ValidationRegistry | `0x3c2aae404b64ddf09f7ef07dfb4f723c9053443d35038263acf7d5d77efcd83` | Team-verified; see `docs/DEPLOYMENT_TRUTH_SHEET.md` |
