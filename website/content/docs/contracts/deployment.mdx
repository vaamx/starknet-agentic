...
- Mainnet Identity/Reputation/Validation registries: owner type is not yet publicly documented in this page; verify in [DEPLOYMENT_TRUTH_SHEET](https://github.com/keep-starknet-strange/starknet-agentic/blob/main/docs/DEPLOYMENT_TRUTH_SHEET.md) before integrating.
- Sepolia Identity/Reputation/Validation registries: owner type is not yet publicly documented in this page; verify in [DEPLOYMENT_TRUTH_SHEET](https://github.com/keep-starknet-strange/starknet-agentic/blob/main/docs/DEPLOYMENT_TRUTH_SHEET.md) before integrating.
