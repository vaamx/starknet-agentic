...
The ERC-8004 Cairo implementation is production-ready with 131+ unit tests and 47 end-to-end tests, and registries deployed on both Starknet mainnet and Sepolia.
</Callout>
...
<Callout type="info" title="Mainnet + Sepolia Live">
ERC-8004 registries are deployed on both Starknet mainnet and Sepolia. For canonical verified addresses (including historical Sepolia set and class hashes), see `docs/DEPLOYMENT_TRUTH_SHEET.md` in the repo.
</Callout>
