...
<Callout type="info" title="Community Project">
  MCP bridges for ChatGPT are community-maintained. See [mcp-openai-bridge](https://github.com/anthropics/mcp-openai-bridge) for setup instructions.
</Callout>
...
| `AVNU_BASE_URL` | No | avnu API URL (defaults to mainnet) |
