...
The MCP server exposes 9 core tools plus 2 conditional tools:
...
<Callout type="info" title="Conditional Tools">
  The last two tools require additional environment variables:
  - `starknet_register_agent` requires `ERC8004_IDENTITY_REGISTRY_ADDRESS`
