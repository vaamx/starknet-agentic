...
Skills follow the [AgentSkills specification](https://github.com/anthropics/agentskills) - a standard format for defining AI agent capabilities that works across different frameworks and models.
</Callout>
