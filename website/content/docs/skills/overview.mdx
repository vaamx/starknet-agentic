...
| Skill | Description |
|-------|-------------|
| [cairo-contracts](/docs/skills/cairo-coding) | Contract structure, storage, events, OZ components |
| [cairo-testing](/docs/skills/cairo-coding) | snforge testing patterns, cheatcodes, fuzzing |
| [cairo-security](/docs/skills/cairo-coding) | Security patterns from 50+ audits |
| [cairo-optimization](/docs/skills/cairo-coding) | Gas optimization, BoundedInt, storage packing |
| [cairo-deploy](/docs/skills/cairo-coding) | Deployment with sncast, verification, multicall |
