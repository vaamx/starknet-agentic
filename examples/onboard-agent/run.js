...
function parseArgs() {
    ...
    if (!tokenUri) {
        ...
        console.log(`No --token-uri provided, using default: ${tokenUri}\n`);
    }
...
async function main() {
    ...
    console.log("");
    console.log(`View on explorer: ${pre.networkConfig.explorer}/contract/${deploy.accountAddress}`);
    console.log("");
    ...
    console.log("  4. Connect to the MCP server for AI-agent operations");
}
main().catch((error) => {
    console.error("\nONBOARDING FAILED\n");
