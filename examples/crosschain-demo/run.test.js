...
import { createSharedUri, parseNonNegativeWei, parseFundingProvider, parseMinStarknetDeployerBalanceWei, parsePositiveIntEnv, resolveEvmAgentId, } from "./run.js";
describe("crosschain-demo helpers", () => {
    ...
    it("parses deployer min balance and rejects invalid values", () => {
        ...
        expect(() => parseMinStarknetDeployerBalanceWei("not-a-number")).toThrow("Invalid MIN_STARKNET_DEPLOYER_BALANCE_WEI");
    });
