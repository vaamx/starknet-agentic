...
AGENT_LLM_PROVIDER_FORECAST=default
AGENT_LLM_PROVIDER_DEBATE=local
AGENT_LLM_PROVIDER_RESOLUTION=default
AGENT_LLM_PROVIDER_TRIAGE=local
XAI_API_KEY=
ANTHROPIC_API_KEY=
...
AGENT_RESEARCH_STEP_TIMEOUT_MS=15000
AGENT_RESEARCH_TOTAL_TIMEOUT_MS=30000
AGENT_RESEARCH_TRIAGE_ENABLED=true
...
AGENT_SINGLE_AGENT_MODE=true
AGENT_ACTORS_PER_TICK=1
...
AGENT_ACTORS_PER_TICK=1
AGENT_LLM_PROVIDER=auto
AGENT_LLM_PROVIDER_FORECAST=xai
AGENT_LLM_PROVIDER_RESOLUTION=xai
AGENT_LLM_PROVIDER_DEBATE=local
AGENT_LLM_PROVIDER_TRIAGE=local
AGENT_RESEARCH_TRIAGE_ENABLED=true
