...
const GEOPOLITICS_REGEX =
  /\bceasefire\b|sanction|nato|invasion|territorial|annexation|sovereignty|un security council|G7|G20|nuclear.*deal|arms.*treaty|missile|drone strike|border conflict|diplomatic|embassy|peace talks|alliance|bloc|proxy war|ukraine.*russia|israel.*gaza|taiwan.*china|south china sea|iran.*nuclear|north korea|regime|coup|civil war/i;
...
const FINANCE_REGEX =
  /\bIPO\b|stock.*split|market cap|S&P 500|nasdaq|dow jones|treasury yield|bond.*rate|interest rate|rate.*cut|rate.*hike|federal reserve|ECB|bank of japan|credit.*rating|default.*bond|merger|acquisition|buyout|hedge fund|short squeeze|options|derivatives|forex|commodity|oil price|gold price|silver|copper|wheat|natural gas/i;
...
const CRYPTO_REGEX =
  /bitcoin|btc|ethereum|eth|starknet|strk|solana|sol|crypto|token|defi|nft|blockchain|tps|gas fee|layer\s?2|zk|rollup|airdrop|memecoin|stablecoin|bridge|wallet|DEX|AMM|liquidity pool|staking|yield|TVL|halving/i;
