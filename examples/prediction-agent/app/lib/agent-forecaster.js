...
exports.forecastMarket = forecastMarket;
exports.extractProbability = extractProbability;
...
async function* forecastMarket(question, context) {
...
function generateDemoForecast(question, context) {
...
### Inside View
The current market is pricing this at ${(marketProb * 100).toFixed(1)}%. ${isYesLeaning
