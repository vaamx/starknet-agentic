...
import { Account, CallData, ETransactionVersion, RpcProvider, byteArray, cairo, } from "starknet";
import { parseValidationRequestHashFromReceipt, readAgentExists, readTotalAgents, readValidationSummary, toU256Calldata, } from "./lib.js";
...
async function main() {
    ...
    const validationRegistry = process.env.ERC8004_VALIDATION_REGISTRY ||
