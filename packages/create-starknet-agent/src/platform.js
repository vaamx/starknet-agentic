 ...
 */
function createOpenClawPlatform(confidence, detectedBy) {
...
function createClaudeCodePlatform(confidence, detectedBy) {
...
function createCursorPlatform(confidence, detectedBy) {
...
function createDaydreamsPlatform(confidence, detectedBy) {
    return {
        type: "daydreams",
        name: "Daydreams",
...
function createGenericMcpPlatform(confidence, detectedBy) {
...
function createStandalonePlatform() {
    return {
        type: "standalone",
 ...
 */
export function getPlatformByType(type) {
...
export function getPlatformDisplayName(platform) {
    const confidenceLabel = platform.confidence === "high"
        ? " (detected)"
 ...
 */
export function formatDetectedPlatforms(platforms) {
    const lines = [];
    for (const platform of platforms) {
        const confidenceIcon = platform.confidence === "high"
            ? "●"
            : platform.confidence === "medium"
                ? "◐"
                : "○";
...
export function isValidPlatformType(type) {
    return ["openclaw", "claude-code", "cursor", "daydreams", "generic-mcp", "standalone"].includes(type);
}
