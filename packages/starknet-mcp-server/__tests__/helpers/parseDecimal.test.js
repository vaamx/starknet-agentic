...
describe("parseDecimalToBigInt", () => {
    ...
    describe("basic conversions", () => {
        ...
        it("converts integer string with 6 decimals", () => {
            expect(parseDecimalToBigInt("1", 6)).toBe(1000000n);
        });
        ...
        it("converts '0.1' with 6 decimals", () => {
            expect(parseDecimalToBigInt("0.1", 6)).toBe(100000n);
        });
        ...
        it("converts large integer '1000000' with 18 decimals", () => {
            expect(parseDecimalToBigInt("1000000", 18)).toBe(1000000000000000000000000n);
        });
    });
    ...
    describe("precision preservation", () => {
        ...
        it("handles 1.23456789 with 18 decimals precisely", () => {
            expect(parseDecimalToBigInt("1.23456789", 18)).toBe(1234567890000000000n);
        });
        ...
        it("handles maximum ERC-20 balance string", () => {
            ...
            expect(parseDecimalToBigInt(maxStr, 0)).toBe(BigInt(maxStr));
        });
    });
    ...
    describe("fractional truncation", () => {
        it("truncates excess decimal places", () => {
            ...
            expect(parseDecimalToBigInt("0.1234567", 6)).toBe(123456n);
        });
        it("truncates at exact boundary", () => {
            expect(parseDecimalToBigInt("0.123456", 6)).toBe(123456n);
        });
